          ...
          <q-item-section class="text-h5 text-weight-bolder">
            <svg xmlns="http://www.w3.org/2000/svg" :width="widthSVG" height="30" viewBox="0 0 197 30" fill="none">
              ...
              <path
                ...
                fill="#5479F7" stroke="#5479F7" stroke-width="0.923855" stroke-miterlimit="10" />
              <path
                ...
                fill="#5479F7" stroke="#5479F7" stroke-width="0.184771" stroke-miterlimit="10" />
              <path
              ...
              <path
                ...
                fill="#5479F7" mask="url(#path-10-inside-1_67_229)" />
              <path
