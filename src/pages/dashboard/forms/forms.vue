<template>
  <fin-portlet style="background-color: transparent">
    <fin-portlet-header>
      <fin-portlet-heading :loading="masterLoading" backArrow><span class="User_heading">Forms Data</span></fin-portlet-heading>
    </fin-portlet-header>
  </fin-portlet>
  ...
  <div class="row">
    <div class="col-12">
      <fin-portlet style="background-color: transparent">
        <fin-portlet-header>
          <fin-portlet-heading :loading="masterLoading"><span class="User_heading">Master Class</span></fin-portlet-heading>
        </fin-portlet-header>
  ...
  <div class="row">
    <div class="col-12">
      <fin-portlet style="background-color: transparent">
        <fin-portlet-header>
          <fin-portlet-heading :loading="contactLoading"><span class="User_heading">Contact-Us</span></fin-portlet-heading>
        </fin-portlet-header>
        <fin-portlet-item class="table-scroll">
  ...
  <div class="row">
    <div class="col-12">
      <fin-portlet style="background-color: transparent">
        <fin-portlet-header>
          <fin-portlet-heading :loading="inquiryLoading"><span class="User_heading">Inquiry</span></fin-portlet-heading>
        </fin-portlet-header>
        <fin-portlet-item class="table-scroll">
  ...
  <div class="row">
    <div class="col-12">
      <fin-portlet style="background-color: transparent">
        <fin-portlet-header>
          <fin-portlet-heading :loading="enrollLoading"><span class="User_heading">Enrollment</span></fin-portlet-heading>
        </fin-portlet-header>
        <fin-portlet-item class="table-scroll">
...
export default {
  ...
  getEnrollData() {
    if (!this.enrollLoading) {
      ...
      const baseUrl = (process.env.VUE_APP_CORE_URL || '').replace(/\/$/g, '') + '/';
      const getWebEnrollUrl = baseUrl + 'api/web-enrolls';

      axios.get(getWebEnrollUrl)
        .then(response => {
  ...
  mounted() {
    // console.log('Component mounted'); // Log to check if the mounted hook is called
    this.getMastersData();
