<template>
  ...
  export default {
    ...
    methods: {
      renderCharts() {
        this.renderChart(this.$refs.barChart, 'bar', 'Cloud Provider Cost Management');
      ...
      renderChart(canvasRef, chartType, chartLabel) {
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Windows',
              data: [2000, 1900, 1950, 1920, 1980], // Dummy data for Windows cost
              backgroundColor: 'rgba(54, 162, 235, 0.6)'
            }, {
              label: 'Linux',
              data: [1850, 1820, 1880, 1800, 1870], // Dummy data for Linux cost
      ...
      renderPieChart(canvasRef) {
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Pie Chart',
              data: [2000, 1850], // Dummy data for Windows and Linux cost
              backgroundColor: [
                'rgba(255, 99, 132, 0.6)',
                'rgba(54, 162, 235, 0.6)'
              ]
      ...
      renderStackedBarChart(canvasRef, chartLabel) {
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Windows',
              data: [1900, 1850, 1870, 1880, 1920],
              backgroundColor: 'rgba(54, 162, 235, 0.6)'
            }, {
              label: 'Linux',
              data: [1820, 1800, 1830, 1850, 1810],
              backgroundColor: 'rgba(255, 99, 132, 0.6)'
            }]
          },
          options: {
