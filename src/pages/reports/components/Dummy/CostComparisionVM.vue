<template>
  ...
  export default {
    ...
    methods: {
      renderCharts() {
        this.renderChart(this.$refs.barChart, 'bar', 'Cost Comparisons Across VM Types');
      ...
      renderChart(canvasRef, chartType, chartLabel) {
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Windows VM',
              data: [1000, 900, 950, 920, 980], // Dummy data for Windows VM
              backgroundColor: 'rgba(54, 162, 235, 0.6)'
            }, {
              label: 'Linux VM',
              data: [850, 820, 880, 800, 870], // Dummy data for Linux VM
      ...
      renderStackedBarChart(canvasRef, chartLabel) {
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: 'Windows VM',
              data: [900, 850, 870, 880, 920],
              backgroundColor: 'rgba(54, 162, 235, 0.6)'
            }, {
              label: 'Linux VM',
              data: [820, 800, 830, 810, 850],
              backgroundColor: 'rgba(255, 99, 132, 0.6)'
            }]
          },
          options: {
