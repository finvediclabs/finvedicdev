<template>
  <div class="VJS_video-player-wrapper shadow-3" v-on:keydown.space="togglePlayPause" tabindex="0">
      ...
      <video class="VJS_video-player" ref="videoPlayer" v-on:click="togglePlayPause" :preload="props.preload">
          <source v-for="source in props.sources" :src="source.url" :type="source.type" controls controlsList="nodownload"/>
